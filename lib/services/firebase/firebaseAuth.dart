...
extension AppFirebaseAuth on FirebaseAuth {
  static final firebase = FirebaseService();
  Future<void> verificationCompletedCallback({
    ...
    try {
      ...
      final partner = firebase.model.partner;
      final user = firebase.model.user;
      if (partner.id != null && firebase.model.user.isUserSignedIn) {
        // log sign in event
        try {
